...
const PLANS = [
  {
    ...
    price: '$79',
    period: '/year',
    text: 'Every deduction you are owed, kept as you go.',
    features: [
      'Photograph a receipt and it files itself',
      'Unlimited expenses and receipts, kept for good',
      'Every year side by side, exported in one click',
      'Read-only accountant access, revoked whenever you like',
    ],
    highlight: false,
  },
  {
    ...
    price: '$149',
    period: '/year',
    text: 'Your own return and up to two businesses, never mixed up.',
    features: [
      'Everything in Individual, for your personal return',
      'Up to two businesses, each with books of their own',
      'Separate totals for each — no untangling at tax time',
      'Read-only accountant access, revoked whenever you like',
    ],
    highlight: true,
  },
        ...
        <section style={{ marginBottom: 'clamp(48px, 8vw, 88px)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 16, maxWidth: 820, margin: '0 auto' }}>
            {[
              ...
              {
                head: 'Taxify',
                sub: `From ${plans[0]?.price || '$79'} a year, and deductible.`,
                ours: true,
                items: [
