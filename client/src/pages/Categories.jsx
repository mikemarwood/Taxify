                    ...
                    {!editing && !confirming && (
                      <div style={{ display: 'flex', gap: 6, flexShrink: 0 }}>
                        ...
                        {/* Only while it is empty.
                            ...
                            A category with expenses in it cannot be deleted
                            without deciding what happens to them, and there is
                            no good answer to that — moving them somewhere
                            arbitrary is wrong, and deleting them takes
                            receipts and lodged figures with it. Offering the
                            button and refusing the press is worse than not
                            offering it, so it appears once the category is
